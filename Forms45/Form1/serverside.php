										...
										<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
											<ul>
												...
												<li>
													...
													<p class="warning"><?php echo $title_err; ?></p>
												</li>
												<br>
												<li>
													<h4>Gender *</h4><br>
													...
													<p class="warning"><?php echo $gender_err; ?></p>
												</li>
												<br>
												<li>
													...
													<p class="warning"><?php echo $fullname_err; ?></p>
												</li>
												<br>
												<li>
													<h4>Name of Father/Husband *</h4>
													<p>*Use format 'N.K.Pathak' Do NOT give any spaces</p><br>
													<input type="text" name="namefathus">
													<p class="warning"><?php echo $namefathus_err; ?></p>
												</li>
												<br>
												<li>
													<h4>Mother's Name *</h4>
													...
													<p class="warning"><?php echo $mothername_err; ?></p>
												</li>
												<br>
												<li>
													...
													<p class="warning"><?php echo $academicpos_err; ?></p>
												</li>
												<br>
												<li>
													<h4>Date of Birth *</h4><br>
													<input type="date" name="dob">
													<p class="warning"><?php echo $dob_err; ?></p>
												</li>
												<br>
												<li>
													...
													<p class="warning"><?php echo $highestqual_err; ?></p>
												</li>
												<br>
												<li>
												...
												<li>
													...
													<p class="warning"><?php echo $statushiqual_err; ?></p>
												</li>
												<br>
												<li>
													...
													<p class="warning"><?php echo $toa_err; ?></p>
												</li>
												<br>
												<li>
													...
													<p class="warning"><?php echo $woa_err; ?></p>
												</li>
												<br>
												<br>
												<li>
